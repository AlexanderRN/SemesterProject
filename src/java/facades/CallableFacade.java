 ...
 */
public final class CallableFacade implements Callable<String> {
    private String url;
    private String from;
    private String to;
    private String date;
    ...
    public CallableFacade(String url, String from, String to, String date, String persons) {
        ...
        runThreads(from, to, date, persons);
    }
    ...
    static String[] hostList = {"http://angularairline-plaul.rhcloud.com/api/flightinfo/", 
    ...
    public void runThreads(String from, String to, String date, String persons){
